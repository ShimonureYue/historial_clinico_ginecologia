...
5. **Tu base de datos** la estructura esta en documentation/expediente_clinico_estructura.sql 
6. **Los datos de de base de datos** estan en documentation/expediente_clinico_full.sql 
...
y la ruta del proyecto es: /Volumes/MiniM4_1/Development/historial_beto_claude
