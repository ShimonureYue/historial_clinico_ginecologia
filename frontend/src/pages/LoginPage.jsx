      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Expediente Clínico</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Ginecología - Iniciar Sesión</p>
          </div>
