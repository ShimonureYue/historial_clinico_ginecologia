...
const STEPS = {
  ...
  install: [
    ...
    'Validando que sea una base de datos valida...',
    'Creando copia de seguridad local...',
    'Instalando nueva base de datos...',
  ],
}

function ProgressOverlay({ type }) {
      ...
      <div className={clsx('space-y-6', anyPending && 'pointer-events-none opacity-50')}>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Copias de seguridad de la base de datos</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm p-5">
            ...
            {ultimo?.exists ? (
              <div className="mb-4 p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                <p className="text-[12px] font-semibold text-slate-500 dark:text-slate-400 uppercase mb-1">Ultimo respaldo</p>
              ...
              <p className="mb-4 text-xs text-slate-400 dark:text-slate-500">No hay respaldos registrados aun.</p>
            )}
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-200">Restaurar ultimo respaldo</h3>
            </div>
              ...
              <div className="space-y-2">
                <div className="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                  <p className="text-xs font-semibold text-red-700 dark:text-red-400">
                    Esto reemplazara la base de datos actual con el ultimo respaldo.
                  </p>
                  <p className="text-xs text-red-600 dark:text-red-400 mt-1">
                    Se creara una copia de seguridad local antes de reemplazar. Deberas reiniciar el servidor despues.
                  </p>
                </div>
                <div className="flex gap-2">
                  ...
                  >
                    <Check className="w-4 h-4" /> Confirmar restauracion
                  </button>
                  <button
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[11px] text-slate-400 dark:text-slate-500 ml-1">— para migrar a otra maquina</span>
          </div>

          <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">
            Pega la URL que te proporciono el administrador del sistema para instalar una copia de la base de datos.
          </p>
          ...
          {confirmInstall && (
            <div className="mt-3 space-y-2">
              <div className="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                <p className="text-xs font-semibold text-red-700 dark:text-red-400">
                  Esto reemplazara TODA la base de datos actual con el archivo de la URL.
                </p>
                <p className="text-xs text-red-600 dark:text-red-400 mt-1">
                  Se creara una copia de seguridad local antes. Deberas reiniciar el servidor despues.
                </p>
              </div>
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold bg-red-600 text-white hover:bg-red-700 transition-colors"
                >
                  <Check className="w-4 h-4" /> Confirmar instalacion
                </button>
                <button
